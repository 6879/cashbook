<template id="">
  <span>
     <div class="card">
        <div class="no-gutters row border-bottom ">
            <div class="col-sm-12 col-md-2 col-xl-2 d-none d-md-block" data-toggle="modal"  data-target="#customerModal">
            ...
            <div class="col-sm-12 col-md-2 col-xl-2 d-none d-md-block" data-toggle="modal"  data-target="#offerModal">
                 <div class="card no-shadow rm-border bg-transparent widget-chart text-center">
                    <div class="icon-wrapper rounded-circle  mb-2">
            ...
            <div class="col-sm-12 col-md-2 col-xl-2 d-none d-md-block" data-toggle="modal"  data-target="#stockModal">
                <div class="card no-shadow rm-border bg-transparent widget-chart text-center">
                    <div class="icon-wrapper rounded-circle  mb-2">
            ...
            <div class="col-sm-12 col-md-2 col-xl-2 d-none d-md-block">
                <div class="card no-shadow rm-border bg-transparent widget-chart text-center">
                    <div class="icon-wrapper rounded-circle  mb-2">
            ...
            <div class="col-sm-12 col-md-2 col-xl-2 d-none d-md-block" data-toggle="modal"  data-target="#stockLimitModal">
                <div class="card no-shadow rm-border bg-transparent widget-chart text-center">
                    <div class="icon-wrapper rounded-circle  mb-2">
            ...
            <form>
              <div class="form-row">
                ...
                <div class="form-group mb-0 col-md-3 col-sm-4 col-6">
                    ...
                    <multiselect v-model="form.salesCustomerEntryId" name="salesCustomerEntryId" :options="salesCustomerLists"  :custom-label="salesCustomerName"  placeholder="Select one" >
                         <span slot="noResult">Oops! Customer Name Not Found</span>
                    </multiselect>
                </div>
                <div class="form-group mb-0 col-md-2 col-sm-4 col-6">
                    <label>Select Price Type</label>
                    <multiselect v-model="form.priceType" name="priceType" :options="priceType" :custom-label="priceName"  placeholder="Select one" >
       ...
       <div class="product-page pl-2" style="background:#E7F1E8">
       ...
       <div class="table-responsive bg-white">
         ...
         <div class="check-bar py-2 px-2">
           <div class="row m-0">
             <div class="col-md-6 col-6 pl-0">
                <div class="radio">
                   <label> <input type="radio" name="gander"> Card </label>
                   <label> <input type="radio" name="gander"> Cadit </label>
                   <label> <input type="radio" name="gander"> Cash </label>
                 </div>
               </div>
         ...
         <div class="product-detail" style="background:#E7F1E8">
           <div class="row m-0" >
             ...
             <div class="col-12">
               <div class="button my-4">
                 <button type="button" class="primary">Print</button>
                 <button type="button" @click.prevent="salesInvoiceEntry()" class="success">Save</button>
                 <button type="button" @click.prevent="salesInvoiceReset()"class="danger">Reset</button>
               </div>
             </div>
           </div>
         </div>
    ...
    export default {
      ...
      methods: {
          ...
          salesInvoiceSingleData() {
            axios.get('/salesInvoiceEntry/'+this.$route.params.salesInvoiceId+'/edit').then(res => {

                this.salesInvoiceNoIncre = res.data.singleSalesInvoiceList.salesInvoiceNo;
                this.form.salesInvoiceNo = res.data.singleSalesInvoiceList.salesInvoiceNo;

                this.form.salesDate = res.data.singleSalesInvoiceList.salesDate;
                this.form.totalQuantity = res.data.singleSalesInvoiceList.totalQuantity;
                this.form.totalBalance = res.data.singleSalesInvoiceList.totalBalance;
                this.form.discountPrice = res.data.singleSalesInvoiceList.discountPrice;
                ...
                this.form.currentTotalAmount = res.data.singleSalesInvoiceList.currentTotalAmount;
                this.form.currentPaidAmount = res.data.singleSalesInvoiceList.currentPaidAmount;
          ...
          salesInvoiceEntry(){
              axios.put('/salesInvoiceEntry/'+this.$route.params.salesInvoiceId,{
              ...
              .then(res => {
                  Toast.fire({
                      icon: 'success',
                      title: 'Sales Invoice Update Successfully'
                  })
                  this.form.reset();
